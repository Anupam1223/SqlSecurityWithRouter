...
from user.database import LocalSession, engine
from user import models, schema, crud
...
@router.post("/create_newuser/", response_model=schema.UserResponse)
...
@router.post("/verify_stored_user/", response_model=schema.Token)
...
@router.get("/get_user/", response_model=schema.User)
